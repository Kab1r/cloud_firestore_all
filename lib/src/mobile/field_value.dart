...
class FieldValue implements intf.FieldValue {
  static dynamic arrayRemove(List elements) => mobile.FieldValue.arrayRemove(elements);
  static dynamic arrayUnion(List elements) => mobile.FieldValue.arrayUnion(elements);
